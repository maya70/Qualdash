...
$Q.Minap = {
    ...
    "variableDict": {"1.01 Hospital identifier": "Admissions",
                      "der_discharge": "Discharges",
                      "der_readmit": "Readmissions",
                      "der_stemi": "PCI patients", 
                      "der_nstemi": "NSTEMI admissions", 
                      "ctbTarget": "CTB Not meeting target",
                      "dtaTarget": "DTA meeting target",
                      "ctbTargetMet": "Met target",
                      "ctb": "Avgerage CTB",
                      "der_bedDays": "Bed Days", 
                      "dtb": "Door-to-Balloon"
                      }, 
    "displayVariables": [
                        ...
                        "mark": "bar", // should remove this 
                        "chart": "grouped",
                        "x": "3.06 Admission Date/Time",
                        "y": ["1.01 Hospital identifier", "4.04 Cause of Death in Hospital"], 
                        "yaggregates": ["count", "sum"], 
                        "yfilters": {"1.01 Hospital identifier": {"where": {"4.04 Cause of Death in Hospital":"0. No"},
                                                                         "valid": ["1. From MI", "3. Other non cardiac related cause", "4. Other cardiac cause"]}, 
                                     "4.04 Cause of Death in Hospital": {"where": {"4.04 Cause of Death in Hospital": ["1. From MI", "3. Other non cardiac related cause", "4. Other cardiac cause"]}, 
                                                                "valid": ["0. No"]}
                                      },
                        "xType": "t",
                        "yType": ["q", "q"],  
                        ...
                        "quantities": [
                                        //{"q":"1.01 Hospital identifier","granT": "admonth", "granP":["unit"], "yaggregates": "count" },                                         
                                        {"q":"der_bedDays", "granT": "admonth", "granP":["unit"], "yaggregates": "sum" }
                                       ], // from tasks with a single quantitative variable                                                                   
                        "granT": {"monthly-annual": ["1.01 Hospital identifier", "4.04 Cause of Death in Hospital"] }   // the first element holds the master view's granT                                             
                        ...
                        "chart": "stacked",
                        "x": "3.06 Admission Date/Time",
                        "y": [ "1.01 Hospital identifier", "2.01 Initial Diagnosis"], 
                        "yaggregates": ["count", "count"], 
                        "yfilters": {"1.01 Hospital identifier": {"where": {"2.01 Initial Diagnosis": "1. Definite myocardial infarction", 
                                                                        "3.10 Was there a Delay before Treatment?": "0. No" },
                                                                          "operator": "AND", 
                                     ...
                                     "2.01 Initial Diagnosis": {"where": { "2.01 Initial Diagnosis":  "1. Definite myocardial infarction",
                                                                          "3.10 Was there a Delay before Treatment?": [ 
                                                                                    "1. Definite myocardial infarction", 
                                                                                    "2. Clinical concern about recent cerebrovascular event or surgery", 
                                                                                    "3. Delay obtaining consent",
                                                                                    "4. Initial ECG ineligible",
                        ...
                        /** Slave Tasks spec begin here **/ 
                        "categories": ["3.10 Was there a Delay before Treatment?", "2.39 Admission Method"],      
                        "quantities": [
                                         {"q":"dtb", "granT": "admonth", "granP":["unit"], "yaggregates": "average"}
                                       ],                                                               
                        "granT": {"monthly-annual": [ "1.01 Hospital identifier", "2.01 Initial Diagnosis"] }             
                        ...
                        "ehr": "Admissions",
                        /** Slave Tasks spec begin here **/ 
                        "categories": ["2.01 Initial Diagnosis", "2.39 Admission Method", "3.10 Was there a Delay before Treatment?"],      
                        "quantities": [
                        ...
                        "yfilters": {"1": {"where": {
                                            "P2Y12": "1", 
                                            "4.05 Beta Blocker": "1. Yes" , 
                                            "4.06 ACEI or ARB": "1. Yes" ,
                                            "4.07 Statin": "1. Yes" ,
                                            "4.08 Aspirin": "1. Yes"      
                            }, 
                            ...
                            "operator": "AND"}, 
                           "2": {"where": {
                                            //"4.27 Thienopyridine Inhibitor": ["0", "2", "3", "4", "8", "9"] ,
                                            //"4.31 Discharged on TIcagrelor (v10.3 Dataset)": ["0", "2", "3", "4", "8", "9"] ,
                                            "P2Y12": "0", 
                                            "4.05 Beta Blocker": ["0. No", "4. Not applicable","2. Contraindicated", "3. Patient declined treatment", "8. Not indicated"] , 
                                            "4.06 ACEI or ARB": ["0. No", "4. Not applicable","2. Contraindicated", "3. Patient declined treatment", "8. Not indicated"] ,
                                            "4.07 Statin": ["0. No", "4. Not applicable","2. Contraindicated", "3. Patient declined treatment", "8. Not indicated"] ,
                                            "4.08 Aspirin": ["0. No", "4. Not applicable","2. Contraindicated", "3. Patient declined treatment", "8. Not indicated"]     },
                        ...
                        "ehr": "Admissions",
                        /** Slave Tasks spec begin here **/ 
                        "categories": ["P2Y12", "4.05 Beta Blocker", "4.07 Statin", "4.06 ACEI or ARB", "4.27 Thienopyridine Inhibitor"],      
                        "quantities": [
                                        //{"q":"4.27 Thienopyridine Inhibitor","granT": "admonth", "granP":["unit"], "yaggregates": "count" },                                         
                        ...
                        "chart": "stacked",
                        "x": "3.06 Admission Date/Time",
                        "y":   ["0", "1", "3", "8", "9"], //"4.09 Was Post Discharge Rehabilitation Arranged?", 
                        "yaggregates": [ "count", "count", "count", "count", "count"], 
                        "xType": "t",
                        "yType": "n",
                        "yfilters": {"0": {"where": {"4.09 Was Post Discharge Rehabilitation Arranged?": "0. No"}, "valid": ["0. No", "1. Yes", "3. Patient declined", "8. Not indicated"] },
                                      "1": {"where": {"4.09 Was Post Discharge Rehabilitation Arranged?": "1. Yes"}, "valid": ["0. No", "1. Yes", "3. Patient declined", "8. Not indicated"] },
                                      "3": {"where": {"4.09 Was Post Discharge Rehabilitation Arranged?": "3. Patient declined"}, "valid": ["0. No", "1. Yes", "3. Patient declined", "8. Not indicated"] },
                                      "8": {"where": {"4.09 Was Post Discharge Rehabilitation Arranged?": "8. Not indicated"}, "valid": ["0. No", "1. Yes", "3. Patient declined", "8. Not indicated"] },
                                      "9": {"where": {"4.09 Was Post Discharge Rehabilitation Arranged?": "9"}, "valid": ["0. No", "1. Yes", "3. Patient declined", "8. Not indicated"] }
                                      },
                        ...
                        "ehr": "Admissions",
                        /** Slave Tasks spec begin here **/ 
                        "categories": ["1.07 Sex", "3.10 Was there a Delay before Treatment?"],      
                        "quantities": [
                        ...
                        "chart": "stacked",
                        "x": "3.06 Admission Date/Time",
                        "y":   ["1", "2", "3", "4", "8"], //"4.09 Was Post Discharge Rehabilitation Arranged?", 
                        "yaggregates": [ "count", "count", "count", "count", "count"], 
                        "xType": "t",
                        "yType": "n",
                        "yfilters": {"1": {"where": {"2.04 Where was Aspirin/other anti-platelet given?": "1. Already on aspirin / antiplatelet drug"}, "valid": ["1. Already on aspirin / antiplatelet drug",                    
                                      ...
                                      "2": {"where": {"2.04 Where was Aspirin/other anti-platelet given?": "2. Aspirin / antiplatelet drug given out of hospital"}, "valid": [ "1. Already on aspirin / antiplatelet drug",                    
                                                                                       "2. Aspirin / antiplatelet drug given out of hospital",          
                                                                                       "3. Aspirin / antiplatelet drug given after arrival in hospital",
                                                                                       "4. Aspirin / antiplatelet contraindicated", "8. Not given" ] },
                                      "3": {"where": {"2.04 Where was Aspirin/other anti-platelet given?": "3. Aspirin / antiplatelet drug given after arrival in hospital"}, "valid": [ "1. Already on aspirin / antiplatelet drug",                    
                                                                                       "2. Aspirin / antiplatelet drug given out of hospital",          
                                                                                       "3. Aspirin / antiplatelet drug given after arrival in hospital",
                                                                                       "4. Aspirin / antiplatelet contraindicated", "8. Not given" ] },
                                      "4": {"where": {"2.04 Where was Aspirin/other anti-platelet given?": "4. Aspirin / antiplatelet contraindicated"}, "valid": [ "1. Already on aspirin / antiplatelet drug",                    
                                                                                       "2. Aspirin / antiplatelet drug given out of hospital",          
                                                                                       "3. Aspirin / antiplatelet drug given after arrival in hospital",
                                                                                       "4. Aspirin / antiplatelet contraindicated", "8. Not given" ] },
                                      "8": {"where": {"2.04 Where was Aspirin/other anti-platelet given?": "8. Not given"}, "valid": [ "1. Already on aspirin / antiplatelet drug",                    
                                                                                       "2. Aspirin / antiplatelet drug given out of hospital",          
                                                                                       "3. Aspirin / antiplatelet drug given after arrival in hospital",
                                                                                       "4. Aspirin / antiplatelet contraindicated", "8. Not given" ] },
                        ...
                        "ehr": "Admissions",
                        /** Slave Tasks spec begin here **/ 
                        "categories": [ "2.39 Admission Method", "3.10 Was there a Delay before Treatment?"],      
                        "quantities": [
                                        //{"q":"der_nstemi","granT": "admonth", "granP":["unit"], "yaggregates": "count" },                                         
                                        //{"q":"der_ctbTarget", "granT": "admonth", "granP":["unit"], "yaggregates": "count"}, 
                                         {"q":"dtaTarget", "granT": "admonth", "granP":["unit"], "yaggregates": "sum"}, 
